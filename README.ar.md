...
# 🦁 XXD Panel 074｜دفتر أيقونات المزاج

### يختزل روح الصورة في أيقونة علامة مستديرة أمامية شبه ثلاثية الأبعاد
...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 074 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.
...
يحدد **Panel 074** العنصر والفعل والعلاقة والاستعارة الأساسية في الأصل، ثم يعيد بناءها بأقل العناصر كأيقونة أمامية أصلية شبه ثلاثية الأبعاد／2.5D. يبقى المحيط دائمًا مربعًا مستديرًا قياسيًا بنسبة 1:1، بينما يصنع الحجب والسماكة والنحت والمسافة داخله حيزًا مجسمًا واحدًا متصلًا. يتعرف المشاهد العنصر أولًا، ثم يفهم العلاقة، ثم يشعر بالعاطفة.

### مناسب لـ

- مفهوم أيقونة قابل للمراجعة فعلاً، بمحيط يطابق معايير App Icon الراقية وسرد داخلي يحمل استعارة أصلية؛
- حفظ روح الصورة بإعادة تنظيم العنصر والفعل والعلاقة الأساسية، بدلاً من حشر الصورة داخل مربع؛
- أسلوب 2.5D حديث وناعم بحجم حقيقي وفضاء متصل، من دون مظهر لعبة بلاستيكية أو زجاج هلامي أو واجهة لعبة؛
- مخرجات أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وحزم خلفيات ومعالجة المجلدات.

### بداية سريعة

> استخدم XXD Panel 074 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** مربع مستدير قياسي · منظور أمامي شبه 3D／2.5D · استخلاص روح المصدر · حجب متصل · نحت مطفأ · اقتراح أيقونة علامة
...
|---|---|
| **الناتج** | أيقونة مستديرة أصلية شبه ثلاثية الأبعاد صالحة لاقتراح هوية علامة أو مراجعة مفهوم أيقونة |
| **البصمة الواضحة** | محيط ثابت 1:1 يحتوي حيزًا أماميًا متصلًا مبنيًا بالحجب والسماكة والنحت والمسافة |
| **احترام المصدر** | يحافظ على العنصر والمحيط والوضعية والعلاقة المركزية، ويشتق اللون كله من الصورة الأصلية |
...
```text
فهم العنصر والفعل والعلاقة والاستعارة → تثبيت مسرح مربع مستدير قياسي 1:1 → إعادة بناء روح المصدر بأقل العناصر الجوهرية → صنع حيز 2.5D متصل بالحجب الأمامي والسماكة والارتفاع والسطوح الناعمة والنحت → إعادة توجيه اللون كله من المصدر → إنهاء نحتي مطفأ وناعم → ترك فراغ هادئ ونص تحريري بالغ القلة خارج الأيقونة
```

## سمات النتيجة النهائية

- يحافظ على محيط 1:1 أمامي بأربعة أضلاع متساوية وزوايا موحدة لا يغيره العنصر.
- يبني الداخل كحيز أمامي متصل بالحجب والسماكة والارتفاع والسطوح الناعمة والنحت الموضعي والمسافة.
- ينظم الأيقونة حول علاقة بصرية واحدة ولا يسمح للتحويل الرمزي أن يصير مجرد عنصر في الوسط.
- يشتق اللون كله من الصورة الأصلية من دون لوحة ثابتة أو أخذ متوسط الألوان.
- يبقي الملمس دقيقًا ومطفأً وناعمًا بين الرسم التحريري والنموذج المصغر والمرئيات ثلاثية الأبعاد للعلامة.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-074-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 074. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-074 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-074 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-074 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-074 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-074 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 074 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-074 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-074`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-074-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-074-prompt.zh-CN.md)

<!-- xxd-panel-catalog:start -->
## دليل مشاريع XXD Panel الكامل

يحافظ كل مشروع من مشاريع Panel الـ74 على موجّهه الأصلي ومنطقه الجمالي المستقل. يسرد الجدول المشاريع من 001 إلى 074 دون أرقام مفقودة، مع تمييز المشروع الحالي بخط عريض.
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–074) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
