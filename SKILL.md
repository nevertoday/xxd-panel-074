...
```text
/xxd-panel-074 <source-or-directory> --mode top-bottom,design-only \
...
1. 上下对照（原图在上，074 设计在下）
2. 左右对照（原图在左，074 设计在右）
...
```text
~/Desktop/xxd/xxd-panel-074/<fresh-task>/
...
- `references/xxd-panel-074-prompt.zh-CN.md`
- `references/xxd-panel-074-prompt.en.md`
